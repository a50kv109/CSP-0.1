...
**Version:** 0.2 (additive)
**Status:** Draft
**Date:** 2026-05-04
**Base Document:** CSP-0.1 — DOI: 10.5281/zenodo.19639060
...
## 2. CORE Classification (Unchanged from v0.1)
...
## 4. Compatibility Layer (NEW in CSP-0.2)

The Compatibility Layer defines the skill's interaction with external data formats
and operational constraints.

**It is an I/O interface. It is NOT part of the cognitive CORE.**

It separates *what* the skill understands (CORE) from *how* it interfaces
with specific data formats (Compatibility).

### 4.1. Ontology

Three hierarchical levels:

- **Category:** Broad type of data payload (`document`, `image`, `structured`, `audio`, `video`).
- **Format:** Specific file format or extension (`pdf`, `json`, `jpg`, `csv`).
- **Capability:** What the skill can explicitly execute upon the given format.
